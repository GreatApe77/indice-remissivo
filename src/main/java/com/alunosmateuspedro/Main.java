...
public class Main {
    public static void main(String[] args) {
        ...
        indiceRemissivo.buscaNoIndice("ciência calor mago estrutura com eficiência");
    }
}
